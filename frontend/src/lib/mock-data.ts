...
export const insights: Insight[] = [
  {
    ...
    detail:
      "Increase stock for Apex-9 Optical Sensors by 22% to avoid regional stock-out in 4 days.",
    priority: "critical",
    confidence: 98,
  ...
  },
  {
    ...
    detail:
      "Competitor 'GlobalLogix' raised prices on Module MK-4. Recommended margin adjustment: +4.5%.",
    priority: "high",
    confidence: 84,
  ...
  },
  {
    ...
    detail:
      "Ceramic Capacitors are overstocked by 38%. Consider a 12% promotional discount this week.",
    priority: "medium",
    confidence: 76,
  ...
  },
  {
    ...
    detail:
      "Single-source risk detected for Titan Castings. Add a secondary supplier within 14 days.",
    priority: "high",
    confidence: 89,
...
export const alerts: Alert[] = [
  {
    ...
    description:
      "Inventory will reach zero in approximately 4 days at current burn rate.",
    severity: "critical",
    time: "12 min ago",
    category: "Inventory",
    resolved: false,
...
export const procurementItems: ProcurementItem[] = [
  {
    ...
    urgency: "critical",
    reason:
      "Predicted stock-out in 4 days; current burn 4.2/day vs 14 on hand.",
  },
  {
    id: "pc2",
    ...
    urgency: "critical",
    reason:
      "Stock at 25% of reorder point; supplier lead time is long, order now.",
  },
  {
    id: "pc3",
  ...
  },
  {
    ...
    urgency: "medium",
    reason:
      "Approaching reorder point in 11 days; consolidate with carbon order.",
  },
];
