...
const products = [
  ...
  { id: "p4", name: "Ceramic Capacitor 220uF", sku: "CRC-220-A", category: "Electronics", stock: 85e3, reorderPoint: 12e3, expiry: "2028-01-10", status: "overstocked", supplier: "ChipWorks Ltd", price: 0.42 },
...
const fmtCurrency = (n) => n >= 1e6 ? `$${(n / 1e6).toFixed(2)}M` : n >= 1e3 ? `$${(n / 1e3).toFixed(1)}K` : `$${n.toFixed(0)}`;
export {
  pricingItems as a,
  products as b,
  salesTrend as c,
  ...
  competitors as e,
  fmtCurrency as f,
  competitorPrices as g,
  alerts as h,
  insights as i,
  inventoryDistribution as j,
  kpis as k,
