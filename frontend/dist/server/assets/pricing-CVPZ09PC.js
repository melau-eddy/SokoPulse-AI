...
import { a as apiClient, P as PageHeader, b as Button, B as Badge, D as Dialog, c as DialogContent, d as DialogHeader, e as DialogTitle, f as DialogDescription, L as Label, I as Input, g as DialogFooter } from "./router-CiYvzxXl.js";
import { K as KpiCard, S as SectionCard } from "./widgets-CuuZ5mHy.js";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-CpucEhFm.js";
import { S as Slider } from "./slider-8PuEUeXW.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-CVzDPju1.js";
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent } from "./tooltip-DGRjzCxX.js";
import { a as pricingItems, f as fmtCurrency, b as formatPrice } from "./mock-data-DiqDx6Z_.js";
...
function PricingPage() {
  ...
  return /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 max-w-[1600px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-6", children: [
      ...
      /* @__PURE__ */ jsx(KpiCard, { label: "Simulated Revenue Lift", value: fmtCurrency(simulatedRevenueLift), hint: "Next 30 days projection", accent: "primary" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "font-mono font-medium", children: [
              (() => {
                ...
                const rate = activeCurrency === "KES" ? 130 : 1;
                const cost = overrideItem.currentPrice * (1 - overrideItem.margin / 100) * rate;
