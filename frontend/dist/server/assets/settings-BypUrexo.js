...
import { h as cn, P as PageHeader, L as Label, I as Input, b as Button, a as apiClient } from "./router-DpSVbM91.js";
import { S as SectionCard } from "./widgets-oDw46614.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BBfNk4yC.js";
import * as SwitchPrimitives from "@radix-ui/react-switch";
import { S as Slider } from "./slider-LrLt57E6.js";
import * as SeparatorPrimitive from "@radix-ui/react-separator";
import { toast } from "sonner";
import { RefreshCw } from "lucide-react";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-C8UVbWpr.js";
    ...
    /* @__PURE__ */ jsxs(Tabs, { defaultValue: "profile", children: [
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "org", children: /* @__PURE__ */ jsxs(SectionCard, { title: "Organization", description: "Company details and locale.", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5 mt-4", children: [
          ...
          /* @__PURE__ */ jsxs(Select, { value: currency, onValueChange: (val) => setCurrency(val), children: [
            /* @__PURE__ */ jsx(SelectTrigger, { id: "org-currency", className: "w-full", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select currency" }) }),
            /* @__PURE__ */ jsxs(SelectContent, { children: [
              /* @__PURE__ */ jsx(SelectItem, { value: "USD", children: "USD ($) - US Dollar" }),
              /* @__PURE__ */ jsx(SelectItem, { value: "KES", children: "KES (KSh) - Kenyan Shilling" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5 mt-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "pt-4 flex justify-end", children: /* @__PURE__ */ jsxs(Button, { disabled: isSavingOrg, onClick: () => {
          ...
          apiClient.updateIndustry(industry, currency, competitorNames).then((res) => {
      ...
      /* @__PURE__ */ jsxs(TabsContent, { value: "api", children: [
        /* @__PURE__ */ jsxs(SectionCard, { title: "API & Integrations", description: "Connect SokoPulse to your ERP, CRM, and warehouse systems.", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsx(SectionCard, { title: "Business Database Tap Connector", description: "Connect SokoPulse directly to your business database to load real-time stock levels, pricing, and sales data into our machine learning demand forecasting engine.", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "db-type", children: "Database Type" }),
            /* @__PURE__ */ jsxs(Select, { value: dbType, onValueChange: (val) => setDbType(val), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { id: "db-type", className: "w-full", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select Database Type" }) }),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsx(SelectItem, { value: "sqlite", children: "SQLite Database File" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "postgresql", disabled: true, children: "PostgreSQL (Enterprise Connection)" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "mysql", disabled: true, children: "MySQL (Enterprise Connection)" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-1.5", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "db-filepath", children: "Database Filepath / Host" }),
            /* @__PURE__ */ jsx(Input, { id: "db-filepath", value: dbFilepath, onChange: (e) => setDbFilepath(e.target.value), placeholder: "Enter full path or default" }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Leave as ",
              /* @__PURE__ */ jsx("code", { className: "bg-muted px-1 py-0.5 rounded", children: "default" }),
              " to generate and connect to a mock business database containing sample inventory and sales history."
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex justify-end pt-2", children: /* @__PURE__ */ jsx(Button, { disabled: isSyncingDb, onClick: () => {
            setIsSyncingDb(true);
            apiClient.syncDatabase(dbType, dbFilepath).then((res) => {
          ...
          }, children: isSyncingDb ? /* @__PURE__ */ jsxs(Fragment, { children: [
