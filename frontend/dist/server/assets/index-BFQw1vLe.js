...
import { K as KpiCard, S as SectionCard, I as InsightCard, b as StatusBadge } from "./widgets-DJY_Wxub.js";
import { S as SalesTrendChart, D as DemandAreaChart, I as InventoryDonut, R as RevenueBarChart, C as CompetitorPriceChart } from "./charts-icuv4hmZ.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-BY6zAHFy.js";
import { b as products, f as fmtCurrency, k as kpis, c as salesTrend, i as insights, d as demandForecast, j as inventoryDistribution, r as revenueByCategory, g as competitorPrices } from "./mock-data-CXBJH4HK.js";
...
function DashboardPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 max-w-[1600px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-6", children: isLoading ? Array.from({
      ...
      /* @__PURE__ */ jsx(KpiCard, { label: "Inventory Value", value: fmtCurrency(kpis.inventoryValue), delta: "+12.4%", trend: "up", accent: "primary" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "Turnover Rate", value: `${kpis.turnover}x`, delta: "+0.6", trend: "up", hint: "Target ≥ 7x" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "Stock-Out Risk", value: `${kpis.stockOutRisk} SKU`, delta: "3 new", trend: "down", accent: "destructive", hint: "Requires action" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "Overstocked", value: `${kpis.overstocked} SKU`, delta: "-4", trend: "up", accent: "warning" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "Predicted Revenue", value: fmtCurrency(kpis.predictedRevenue), delta: "+8.1%", trend: "up", hint: "Next 30 days" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "AI Confidence", value: `${kpis.aiConfidence}%`, delta: "Stable", trend: "flat", accent: "primary", hint: "1.2M signals" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "Active Suppliers", value: `${kpis.activeSuppliers}`, delta: "3 delayed", trend: "down" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "Competitors Tracked", value: `${kpis.competitorsMonitored}`, delta: "Live", trend: "up", accent: "success" })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsx(SectionCard, { title: "Sales Trend", description: "Monthly performance vs. AI forecast", children: isLoading ? /* @__PURE__ */ jsx("div", { className: "h-[260px] flex flex-col justify-between py-2", children: /* @__PURE__ */ jsx(Skeleton, { className: "h-full w-full" }) }) : /* @__PURE__ */ jsx(SalesTrendChart, { data: salesTrend }) }) }),
      ...
      ] }, i)) : insights.slice(0, 3).map((i) => /* @__PURE__ */ jsx(InsightCard, { insight: i, onAction: () => toast.success(`${i.action} queued`) }, i.id)) }) }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsx(SectionCard, { title: "Demand Forecast vs. Actual", description: "8-week rolling window", children: isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-[280px] w-full" }) : /* @__PURE__ */ jsx(DemandAreaChart, { data: demandForecast }) }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Critical Inventory", description: "Items requiring immediate action", children: isLoading ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: critical.map((p) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsx(Button, { variant: "link", size: "sm", onClick: () => toast.success(`Replenishment queued for ${p.name}`), children: "Restock" }) })
        ] }, p.id)) })
      ] }) })
    ] })
  ] });
