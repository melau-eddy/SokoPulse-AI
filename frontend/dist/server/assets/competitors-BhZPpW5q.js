...
import { a as apiClient, P as PageHeader, b as Button, L as Label, B as Badge, D as Dialog, c as DialogContent, d as DialogHeader, e as DialogTitle, f as DialogDescription, g as DialogFooter } from "./router-DpSVbM91.js";
import { K as KpiCard, C as Card, S as SectionCard } from "./widgets-oDw46614.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-C8UVbWpr.js";
import { C as CompetitorPriceChart } from "./charts-CgHWaLLA.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-DOVgjzHo.js";
import { T as TooltipProvider } from "./tooltip-C3hSsrva.js";
import { g as competitors, h as competitorPrices, b as pricingItems, f as formatPrice } from "./mock-data-Nl4nWPc2.js";
...
function CompetitorsPage() {
  ...
  const triggerScrapeRefresh = () => {
    ...
    apiClient.triggerCompetitorScrape(industry, activeCurrency, competitorNames).then((res) => {
      setIsScraping(false);
      if (res) {
        if (res.competitors) setCompetitors(res.competitors);
        if (res.competitorPrices) setCompetitorPrices(res.competitorPrices);
  ...
  return /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 max-w-[1600px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4 mb-6", children: [
      /* @__PURE__ */ jsx(KpiCard, { label: "Cheapest Competitor", value: cheapestCompetitor.name, hint: `Price: ${formatPrice(cheapestCompetitor.itemPrice)} (Avg)`, accent: "success" }),
      /* @__PURE__ */ jsx(KpiCard, { label: "Highest Competitor", value: highestCompetitor.name, hint: `Price: ${formatPrice(highestCompetitor.itemPrice)} (Avg)`, accent: "warning" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6", children: simulatedCompetitors.map((c) => /* @__PURE__ */ jsxs(Card, { className: "p-5 gap-3 flex flex-col justify-between", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "my-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-2xl font-bold font-mono tracking-tight", children: formatPrice(c.itemPrice) }),
    ...
    /* @__PURE__ */ jsx(SectionCard, { title: "Product Comparative Price Matrix", description: `Competitor pricing audit matrix for ${activeProduct.product}`, children: /* @__PURE__ */ jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: simulatedCompetitors.map((c) => {
        ...
        return /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "text-right font-mono font-semibold", children: formatPrice(c.itemPrice) }),
    ...
    /* @__PURE__ */ jsx(Dialog, { open: showOppDialog, onOpenChange: setShowOppDialog, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "py-2", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: pricingItems$1.slice(0, 3).map((item) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "text-right font-mono text-xs", children: formatPrice(item.currentPrice) }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-right font-mono text-xs", children: formatPrice(item.competitorAvg) }),
          /* @__PURE__ */ jsxs(TableCell, { className: "text-right text-success font-mono text-xs font-semibold", children: [
            "+",
            formatPrice(item.recommendedPrice - item.currentPrice, 0),
            " (",
            item.expectedImpact,
            "%)"
          ] }),
