...
import { m as getCurrencySymbol, n as getCurrencyRate } from "./mock-data-DiqDx6Z_.js";
const axisProps = {
...
function SalesTrendChart({
  ...
  return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(
    LineChart,
    {
      data,
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(YAxis, { ...axisProps, tickFormatter: (v) => `${getCurrencySymbol()}${Math.round(v * getCurrencyRate() / 1e3)}k` }),
        /* @__PURE__ */ jsx(
          Tooltip,
          {
...
function DemandAreaChart({
  ...
  return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxs(
    AreaChart,
    {
      data,
      margin: { top: 10, right: 10, left: -10, bottom: 0 },
  ...
  return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxs(
    LineChart,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(YAxis, { ...axisProps, tickFormatter: (v) => `${getCurrencySymbol()}${Math.round(v * getCurrencyRate()).toLocaleString()}` }),
        /* @__PURE__ */ jsx(
          Tooltip,
          {
            contentStyle: tooltipStyle,
